...
# create model name
FR_model_name = "FR_model_" + "_".join(
...
# ==============================================================
results_filename = f"./trained_model/{FR_model_name.replace('.pth', '.txt')}"


with open(results_filename, 'w') as f:
    f.write("==== FR Model Results Summary ====\n")
...
model_path = f"./trained_model/movie/{FR_model_name}"
# ✅ Save model weights
