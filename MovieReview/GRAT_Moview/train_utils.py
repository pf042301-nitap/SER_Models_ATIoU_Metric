...
def prepare_dataset(configs: dict):
    ...
    if configs['dataset'] == 'movie':

        train_dataset = MovieData(
            data_dir=configs['train_path'],
            mode='train',
            word2idx=vocab.w2i,
            balance=True,
        ...
        dev_dataset = MovieData(
            data_dir=configs['dev_path'],
            mode='dev',
            word2idx=vocab.w2i,
            balance=False,
            max_length=configs["max_length"]
        ...
        test_dataset = MovieAnnotation(
            annotation_path=configs['test_path'],
            word2idx=vocab.w2i,
            max_length=configs["max_length"]
        )
